...
public class Developer implements Serializable{
    ...
    @Size(min = 2, max = 50, message = "Name deber contener entre 2 y 50 caracteres")
    private String name;

    @Column(name="dev_surname")
    @Size(min = 2, max = 50, message = "Surname deber contener entre 2 y 50 caracteres")
    private String surname;

    @Column(name="email")
    @Email(message = "Email deber ser válido")
    private String email;


    @Column(name="linkedin_url")
    @ValidUrl(message = "Formato de URL incorrecto")
